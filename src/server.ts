...
/* ------------------------------------------------------------------ */
/* MCP Server factory (shared by stdio and HTTP transports)            */
/* ------------------------------------------------------------------ */
...
export function createMcpServer(): McpServer {
  ...
  server.tool(
    ...
    {
      fileId: z.string().describe("Drive file ID or URL"),
      saveTo: z.string().optional().describe("Optional local path to save the file contents to (local stdio mode only)"),
    },
    async ({ fileId, saveTo }) => {
